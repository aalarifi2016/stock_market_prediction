...
class HistoricalData(models.Model):
    ...
    adj_close = models.DecimalField(db_column='Adj Close', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
